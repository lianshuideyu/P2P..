...
public class ImpAdapter1 extends ProductAdapter1<InvestProductBean.DataBean> {

    public ImpAdapter1(Context context, List<InvestProductBean.DataBean> datas) {
        super(context, datas);
    }

    @Override
    public View getItemView(int position, View converView, ViewGroup viewGroup, List<InvestProductBean.DataBean> datas) {
